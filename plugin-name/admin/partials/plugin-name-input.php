...
<fieldset>
	...
	<input type="<?php echo esc_attr($options['type']); ?>" class="<?php echo esc_attr($options['input_class']); ?>" name="<?php echo esc_attr($option_id); ?>" id="<?php echo esc_attr($option_id); ?>" value="<?php echo esc_attr($option_value); ?>"/>
	<?php
